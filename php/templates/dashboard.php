...
<main class="main-content">
  ...
  <section class="view" id="view-accounts">
    ...
    if (!empty($_GET['meta_connected'])) {
        $n = (int)$_GET['meta_connected'];
        echo "<div class='oauth-success'>
                <svg width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2.5'><polyline points='20 6 9 17 4 12'/></svg>
                Facebook connected! <strong>{$n} page" . ($n !== 1 ? 's' : '') . "</strong> linked and ready to sync.
              </div>";
    }
    ?>
    <div class="two-col">
      ...
      <div class="card">
        <div class="card-header"><h3>Connect Ad Account</h3></div>

        <!-- ── Meta: One-click sign in ───────────────────────────────────── -->
        <div class="connect-section">
          <div class="connect-platform-label">
            ...
            Facebook / Instagram / WhatsApp Leads
          </div>
          <p class="connect-desc">
            Sign in with your Facebook account. We'll automatically find your Pages and Ad Accounts — no copy-pasting tokens needed.
          </p>
          <a href="/auth/meta" class="btn-connect-fb">
          ...
          <p class="connect-note">
            You'll be asked to select your Business Page and grant read-only access to your lead forms. We never post anything on your behalf.
          </p>
        </div>

        <div class="connect-divider"><span>or connect Google Ads</span></div>
